...
static int __init proc_cmdline_init(void)
{
 ...
 +	 * by userspace in order to pass SafetyNet CTS check.
 	 * an attempt to fix passing SafetyNet CTS check from https://github.com/sultanxda/android_kernel_oneplus_msm8996/commit/abc05b16bbd33521c2fffaf491c5657a94bfcfc5
 +	 */
